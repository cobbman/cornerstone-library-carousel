<?php
/*
Plugin Name: Cornerstone Library: Scrolling Elements
 ...
 * => Enqueue Scripts
 * ---------------------------------------------------------------------------*/
function bw_cornerstone_horiz_scroll_scripts() {
...
add_action( 'wp_enqueue_scripts', 'bw_cornerstone_horiz_scroll_scripts', 100 );
...
function bw_cornerstone_horiz_scroll() {
  ...
  cornerstone_add_element( 'Custom_Horizontal_Scroll' );
  cornerstone_add_element( 'Custom_Horizontal_Scroll_Item' );
}